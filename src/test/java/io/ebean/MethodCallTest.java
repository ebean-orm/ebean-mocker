...
public class MethodCallTest {
  ...
  public void testAddArgs() throws Exception {
    ...
    io.ebean.MethodCall methodCall = io.ebean.MethodCall.of("test");
  ...
  public void testAddArgs1() throws Exception {
    ...
    io.ebean.MethodCall methodCall = io.ebean.MethodCall.of("test1").with("name", "Jim");
  ...
  public void testAddArgs2() throws Exception {
    ...
    io.ebean.MethodCall methodCall = io.ebean.MethodCall.of("test1").with("name", "Jim", "age", 43L);
  ...
  public void testAddArgs3() throws Exception {
    ...
    io.ebean.MethodCall methodCall = io.ebean.MethodCall.of("test1").with("name", "Jim", "age", 43L, "status", CascadeType.ALL);
